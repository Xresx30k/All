...
url_izin="https://raw.githubusercontent.com/Xresx30k/Izin/main/ip"
...
function DOMAINS_MANAGER() {
    ...
    if [ "$DOMAINS_SELECT" == "1" ]; then
        ...
        wget https://raw.githubusercontent.com/Xresx30k/All/main/domains.sh \
...
INSTALL_WEBSOCKET() {
wget https://raw.githubusercontent.com/Xresx30k/All/main/ws/install-ws.sh && chmod +x install-ws.sh && ./install-ws.sh
wget https://raw.githubusercontent.com/Xresx30k/All/main/ws/banner_ssh.sh && chmod +x banner_ssh.sh && ./banner_ssh.sh
}

INSTALL_BACKUP() {
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://github.com/Xresx30k/All/raw/main/rclone.conf"
...
INSTALL_OHP() {
wget https://raw.githubusercontent.com/Xresx30k/All/main/ws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
}

INSTALL_FEATURE() {
wget https://raw.githubusercontent.com/Xresx30k/All/main/menu/install_menu.sh && chmod +x install_menu.sh && ./install_menu.sh
}

INSTALL_UDP_CUSTOM() {
wget https://raw.githubusercontent.com/Xresx30k/All/main/ws/UDP.sh && chmod +x UDP.sh && ./UDP.sh
}
...
wget https://raw.githubusercontent.com/Xresx30k/All/main/install_cron.sh && chmod +x install_cron.sh && ./install_cron.sh
clear
}
...
echo -e "\e[91;1m ================================ \e[0m"
cd
wget https://raw.githubusercontent.com/Xresx30k/All/main/PACKAGES/tools.sh && chmod +x tools.sh && ./tools.sh
wget -q -O /etc/port.txt "https://raw.githubusercontent.com/Xresx30k/All/main/PACKAGES/port.txt"
...
wget https://raw.githubusercontent.com/Xresx30k/All/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/Xresx30k/All/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
# limit quota & service xray
wget https://raw.githubusercontent.com/Xresx30k/All/main/Xbw_LIMIT/install.sh && chmod +x install.sh && ./install.sh
clear
# limit service ip xray
wget https://raw.githubusercontent.com/Xresx30k/All/main/AUTOKILL_SERVICE/service.sh && chmod +x service.sh && ./service.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Xresx30k/All/main/versi  )
...
CHATID="7643941523"
KEY="7843600915:AAGPlwNHpYb5HEQGtaleXTb3DKeWsUDo7r8"
...
-d "reply_markup={\"inline_keyboard\":[[{\"text\":\" ʙᴜʏ ꜱᴄʀɪᴘᴛ \",\"url\":\"https://wa.me/+6285194758303\"}]]}"
